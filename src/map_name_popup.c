...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_OLDALE_MEADOW] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PETALBURG_FIELD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WOODS_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DEVON_CORP] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_TRICK_HOUSE] = MAPPOPUP_THEME_MARBLE,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_OLDALE_MEADOW] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PETALBURG_FIELD] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WOODS_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DEVON_CORP] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TRICK_HOUSE] = MAPPOPUP_THEME_BW_DEFAULT,
};
