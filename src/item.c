...
void SetBagItemsPointers(void)
{
    ...
    gBagPockets[POCKET_HELD_ITEMS].itemSlots = gSaveBlock1Ptr->bag.heldItems;
    gBagPockets[POCKET_HELD_ITEMS].capacity = BAG_HELD_ITEMS_COUNT;
    ...
    gBagPockets[POCKET_GEMS].itemSlots = gSaveBlock1Ptr->bag.gems;
    gBagPockets[POCKET_GEMS].capacity = BAG_GEMS_COUNT;
    gBagPockets[POCKET_GEMS].id = POCKET_GEMS;
