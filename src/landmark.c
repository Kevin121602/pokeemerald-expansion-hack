...
static const u8 LandmarkName_SpiralWoods[] = _("SPIRAL WOODS");
...
static const u8 LandmarkName_FrigidPath[] = _("FRIGID PATH");
...
static const u8 LandmarkName_SpiralCave[] = _("SPIRAL CAVE");
...
static const struct Landmark Landmark_SpiralWoods = {LandmarkName_SpiralWoods, -1};
...
static const struct Landmark Landmark_FrigidPath = {LandmarkName_FrigidPath, -1};
...
static const struct Landmark Landmark_SpiralCave = {LandmarkName_SpiralCave, -1};
...
static const struct Landmark *const Landmarks_LoneTreeCape_2[]  =
{
    &Landmark_AlteringCave,
    NULL,
};

static const struct Landmark *const Landmarks_LightningMeadow_0[]  =
{
    &Landmark_FlowerShop,
    NULL,
};

static const struct Landmark *const Landmarks_LightningMeadow_1[]  =
{
    &Landmark_SpiralWoods,
    &Landmark_MrBrineysCottage,
    NULL,
};

static const struct Landmark *const Landmarks_RouteSeven_0[]  =
{
    &Landmark_IslandCave,
    NULL,
};

static const struct Landmark *const Landmarks_RouteFour_1[]  =
{
    &Landmark_SpiralCave,
    NULL,
};

static const struct Landmark *const Landmarks_RouteFive_0[]  =
{
    &Landmark_AbandonedShip,
    NULL,
};

static const struct Landmark *const Landmarks_RouteSix_0[]  =
{
...
static const struct Landmark *const Landmarks_RouteEight_0[]  =
{
...
static const struct Landmark *const Landmarks_RouteEight_1[]  =
{
    &Landmark_CyclingRoad,
    NULL,
};

static const struct Landmark *const Landmarks_RouteEight_2[]  =
{
    &Landmark_CyclingRoad,
    &Landmark_TrickHouse,
    NULL,
...
{
    {MAPSEC_LONE_TREE_CAPE, 2, Landmarks_LoneTreeCape_2},
    {MAPSEC_LIGHTNING_MEADOW, 0, Landmarks_LightningMeadow_0},
    {MAPSEC_LIGHTNING_MEADOW, 1, Landmarks_LightningMeadow_1},
    {MAPSEC_ROUTE_SEVEN, 0, Landmarks_RouteSeven_0},
    {MAPSEC_ROUTE_FOUR, 1, Landmarks_RouteFour_1},
    {MAPSEC_ROUTE_FIVE, 0, Landmarks_RouteFive_0},
    {MAPSEC_ROUTE_SIX, 0, Landmarks_RouteSix_0},
    {MAPSEC_ROUTE_EIGHT, 0, Landmarks_RouteEight_0},
    {MAPSEC_ROUTE_EIGHT, 1, Landmarks_RouteEight_1},
    {MAPSEC_ROUTE_EIGHT, 2, Landmarks_RouteEight_2},
