...
static void PrepareBagForWallyTutorial(void)
{
    ...
    memcpy(sTempWallyBag->bagPocket_Gems, gSaveBlock1Ptr->bag.gems, sizeof(gSaveBlock1Ptr->bag.gems));
    ...
    memset(gSaveBlock1Ptr->bag.gems, 0, sizeof(gSaveBlock1Ptr->bag.gems));
...
static void RestoreBagAfterWallyTutorial(void)
{
    ...
    memcpy(gSaveBlock1Ptr->bag.gems, sTempWallyBag->bagPocket_Gems, sizeof(sTempWallyBag->bagPocket_Gems));
