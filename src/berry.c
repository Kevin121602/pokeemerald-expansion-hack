...
const struct Berry gBerries[] =
{
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_GREEN,
        .size = 34,
        .maxYield = YIELD_RATE(25, 25, 25, 25),
        .minYield = YIELD_RATE(15, 15, 15, 15),
    ...
    [ITEM_FIGY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 100,
        .maxYield = YIELD_RATE(10, 10, 10, 10),
        .minYield = YIELD_RATE(5, 5, 5, 5),
    ...
    [ITEM_RAZZ_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 120,
        .maxYield = YIELD_RATE(5, 5, 5, 5),
        .minYield = YIELD_RATE(3, 3, 3, 3),
