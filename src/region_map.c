...
{
    [MAPSEC_SPIRAL_TOWN] = {MAP_GROUP(SPIRAL_TOWN), MAP_NUM(SPIRAL_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_SPIRAL_TOWN:
        return FlagGet(FLAG_VISITED_SPIRAL_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_SPIRAL_TOWN;
    for (mapSecId = MAPSEC_SPIRAL_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
