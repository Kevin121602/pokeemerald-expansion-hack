...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_ROUTE_SEVEN},
    ...
    {MAPSEC_SPIRAL_WOODS,               MAPSEC_LIGHTNING_MEADOW},
    ...
    {MAPSEC_ALTERING_CAVE,              MAPSEC_LONE_TREE_CAPE},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_LONE_TREE_CAPE},
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_ROUTE_FIVE},
...
static const u16 sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
    ...
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_ROUTE_SEVEN,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_ROUTE_SEVEN,
...
{
    [MAPSEC_CENTER_TOWN] = {MAP_GROUP(CENTER_TOWN), MAP_NUM(CENTER_TOWN), HEAL_LOCATION_CENTER_TOWN_PLAYERS_HOUSE_2F},
    [MAPSEC_CRATER_POND] = {MAP_GROUP(CRATER_POND), MAP_NUM(CRATER_POND), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ROUTE_THREE] = {MAP_GROUP(ROUTE_THREE), MAP_NUM(ROUTE_THREE), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_SPIRAL_CITY] = {MAP_GROUP(SPIRAL_CITY), MAP_NUM(SPIRAL_CITY), HEAL_LOCATION_SPIRAL_CITY},
    ...
    [MAPSEC_ROUTE_ONE] = {MAP_GROUP(ROUTE_ONE), MAP_NUM(ROUTE_ONE), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_TWO] = {MAP_GROUP(ROUTE_TWO), MAP_NUM(ROUTE_TWO), HEAL_LOCATION_NONE},
    [MAPSEC_LONE_TREE_CAPE] = {MAP_GROUP(LONE_TREE_CAPE), MAP_NUM(LONE_TREE_CAPE), HEAL_LOCATION_NONE},
    [MAPSEC_LIGHTNING_MEADOW] = {MAP_GROUP(LIGHTNING_MEADOW), MAP_NUM(LIGHTNING_MEADOW), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_SEVEN] = {MAP_GROUP(ROUTE_SEVEN), MAP_NUM(ROUTE_SEVEN), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_FOUR] = {MAP_GROUP(ROUTE_FOUR), MAP_NUM(ROUTE_FOUR), HEAL_LOCATION_NONE},
    [MAPSEC_SEASHELL_BEACH] = {MAP_GROUP(SEASHELL_BEACH), MAP_NUM(SEASHELL_BEACH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_FIVE] = {MAP_GROUP(ROUTE_FIVE), MAP_NUM(ROUTE_FIVE), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_SIX] = {MAP_GROUP(ROUTE_SIX), MAP_NUM(ROUTE_SIX), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_EIGHT] = {MAP_GROUP(ROUTE_EIGHT), MAP_NUM(ROUTE_EIGHT), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_CENTER_TOWN:
        return FlagGet(FLAG_VISITED_CENTER_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CRATER_POND:
    ...
    case MAPSEC_SPIRAL_CITY:
        return FlagGet(FLAG_VISITED_SPIRAL_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_CENTER_TOWN;
    for (mapSecId = MAPSEC_CENTER_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_CENTER_TOWN:
                    SetWarpDestinationToHealLocation(HEAL_LOCATION_CENTER_TOWN_PLAYERS_HOUSE);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
