...
/*static const u16 sWeatherFlagsInfo[][3] =
{
    ...
    [ENUM_WEATHER_HAIL] = {B_WEATHER_HEAVY_HAIL_TEMPORARY, B_WEATHER_HEAVY_HAIL_PERMANENT, HOLD_EFFECT_ICY_ROCK},
    [ENUM_WEATHER_STRONG_WINDS] = {B_WEATHER_STRONG_WINDS, B_WEATHER_STRONG_WINDS, HOLD_EFFECT_NONE},
    [ENUM_WEATHER_SNOW] = {B_WEATHER_SNOW_NORMAL_TEMPORARY, B_WEATHER_SNOW_NORMAL_PERMANENT, HOLD_EFFECT_ICY_ROCK},
...
bool32 TryChangeBattleWeather(u32 battler, u32 weatherEnumId, bool32 viaAbility)
{
    ...
    {
        u32 rock = sBattleWeatherInfo[weatherEnumId].rock;
        gBattleWeather = sBattleWeatherInfo[weatherEnumId].flag;
...
static bool32 TryChangeBattleTerrain(u32 battler, u32 statusFlag, u16 *timer, bool32 viaAbility)
{
...
u32 AbilityBattleEffects(u32 caseID, u32 battler, u32 ability, u32 special, u32 moveArg)
{
        ...
        if (!(gBattleTypeFlags & BATTLE_TYPE_RECORDED))
        {
            ...
            case WEATHER_SNOW:
                if (!(gBattleWeather & B_WEATHER_SNOW))
                {
                    ...
                    {
                        gBattleWeather = B_WEATHER_SNOW_NORMAL;
    ...
    case ABILITYEFFECT_ON_SWITCHIN:
        ...
        case ABILITY_SNOW_WARNING:
            ...
            else if (GetGenConfig(GEN_SNOW_WARNING) < GEN_9 && TryChangeBattleWeather(battler, BATTLE_WEATHER_HEAVY_HAIL, TRUE))
            {
