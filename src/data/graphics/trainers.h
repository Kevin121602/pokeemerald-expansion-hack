...
const u16 gTrainerPalette_TrainerRiley[] = INCBIN_U16("graphics/trainers/front_pics/riley.gbapal");

const u32 gTrainerFrontPic_TrainerCheryl[] = INCBIN_U32("graphics/trainers/front_pics/cheryl.4bpp.lz");
const u16 gTrainerPalette_TrainerCheryl[] = INCBIN_U16("graphics/trainers/front_pics/cheryl.gbapal");

const u32 gTrainerFrontPic_TrainerMarley[] = INCBIN_U32("graphics/trainers/front_pics/marley.4bpp.lz");
const u16 gTrainerPalette_TrainerMarley[] = INCBIN_U16("graphics/trainers/front_pics/marley.gbapal");

const u32 gTrainerFrontPic_TrainerMira[] = INCBIN_U32("graphics/trainers/front_pics/mira.4bpp.lz");
const u16 gTrainerPalette_TrainerMira[] = INCBIN_U16("graphics/trainers/front_pics/mira.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_RILEY, gTrainerFrontPic_TrainerRiley, gTrainerPalette_TrainerRiley),
    TRAINER_SPRITE(TRAINER_PIC_CHERYL, gTrainerFrontPic_TrainerCheryl, gTrainerPalette_TrainerCheryl),
    TRAINER_SPRITE(TRAINER_PIC_MARLEY, gTrainerFrontPic_TrainerMarley, gTrainerPalette_TrainerMarley),
    TRAINER_SPRITE(TRAINER_PIC_MIRA, gTrainerFrontPic_TrainerMira, gTrainerPalette_TrainerMira),
    TRAINER_SPRITE(TRAINER_PIC_BUCK, gTrainerFrontPic_LeaderBuck, gTrainerPalette_LeaderBuck),
};
