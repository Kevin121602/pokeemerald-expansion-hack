...
static const struct MenuAction MultichoiceList_ChangeIV[] =
{
    {gText_HP4},
    {gText_AttackLC},
    {gText_DefenseLC},
...
static const struct MenuAction MultichoiceList_BirchGameInfo[] =
{
    {gText_LevelCaps},
    {gText_HeartScales},
    {gText_TrickHouse},
...
const u8 *const gStdStrings[] =
{
    ...
    [STDSTRING_HELDITEMS] = gText_HeldItems,
