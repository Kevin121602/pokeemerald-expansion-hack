...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, (B_WEATHER_SANDSTORM | B_WEATHER_ERRATIC), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, (B_WEATHER_SANDSTORM | B_WEATHER_ERRATIC)},
