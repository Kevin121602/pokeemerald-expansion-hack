...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_RAINY, B_WEATHER_RAIN | B_WEATHER_ERRATIC, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_SNOWY, B_WEATHER_HEAVY_HAIL | B_WEATHER_SNOW_NORMAL, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HEAVY_HAIL | B_WEATHER_SNOW_NORMAL), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_RAINY, B_WEATHER_RAIN | B_WEATHER_ERRATIC},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_SNOWY, B_WEATHER_HEAVY_HAIL | B_WEATHER_SNOW_NORMAL},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HEAVY_HAIL | B_WEATHER_SNOW_NORMAL)},
