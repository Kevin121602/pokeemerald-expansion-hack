...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERGROW, ABILITY_SCRAPPY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Decidueye"),
        .cryId = CRY_DECIDUEYE,
        .natDexNum = NATIONAL_DEX_DECIDUEYE,
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_NONE, ABILITY_PICKUP },
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_NONE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_CRABOMINABLE}),
    },
    ...
    [SPECIES_ORICORIO_BAILE] =
    {
        ...
        .expYield = 167,
        .evYield_SpAttack = 2,
        .itemCommon = ITEM_RAINBOW_NECTAR,
        .itemRare = ITEM_RAINBOW_NECTAR,
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_SHIELD_DUST, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_NONE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_NO_GUARD, ABILITY_NONE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .abilities = { ABILITY_SHARPNESS, ABILITY_BAD_COMPANY, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_RAIN_DISH, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_SHIINOTIC}),
    },
    ...
    [SPECIES_TSAREENA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_STRIKER, ABILITY_QUEENLY_MAJESTY, ABILITY_SWEET_VEIL },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_GOLISOPOD}),
    },
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_PALOSSAND}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_CLOUD_NINE, ABILITY_NONE, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_NIHILEGO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BUZZWOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PHEROMOSA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIMBER, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BATTERY, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GUZZLORD] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NONE, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_UNNERVE, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_BLACEPHALON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 55, SPECIES_MELMETAL}),
    },
