...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_STATIC },
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pawmo"),
        .cryId = CRY_PAWMO,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_PAWMOT}),
    },
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_NONE, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MAUSHOLD_THREE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_NONE, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_NACLSTACK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_GARGANACL}),
    },
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_BELLIBOLT}),
    },
    ...
    [SPECIES_BELLIBOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_ELECTROMORPHOSIS, ABILITY_NONE, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MASCHIFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_MABOSSTIFF}),
    },
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_BRAMBLEGHAST}),
    },
    ...
    [SPECIES_KLAWF] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_SHELL_ARMOR, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Klawf"),
        .cryId = CRY_KLAWF,
    ...
    [SPECIES_CAPSAKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_SCOVILLAIN}),
    },
    ...
    [SPECIES_SCOVILLAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_RABSCA}),
    },
    ...
    [SPECIES_FLITTLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_ESPATHRA}),
    },
    ...
    [SPECIES_ESPATHRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_SPEED_BOOST, ABILITY_OPPORTUNIST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_ROCKY_PAYLOAD, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_REVAVROOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_OVERCOAT, ABILITY_FILTER, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_NONE, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DONDOZO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_UNAWARE, ABILITY_NONE, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TATSUGIRI_CURLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_NONE, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .abilities = { ABILITY_HOSPITALITY, ABILITY_HEATPROOF, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_SINISTCHA_UNREMARKABLE}),
    ...
    [SPECIES_POLTCHAGEIST_ARTISAN] =
    {
        ...
        .levelUpLearnset = sPoltchageistLevelUpLearnset,
        .teachableLearnset = sPoltchageistTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_SINISTCHA_MASTERPIECE}),
        .formSpeciesIdTable = sPoltchageistFormSpeciesIdTable,
    },
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)    \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_GRASS, ABILITY_INNER_FOCUS,                        BODY_COLOR_GREEN, 1, 6, 1, FALSE),
    [SPECIES_OGERPON_WELLSPRING]       = OGERPON_SPECIES_INFO(Wellspring,  Wellspring,      TYPE_WATER, ABILITY_WATER_VEIL,                   BODY_COLOR_BLUE,  1, 6, 0, FALSE),
