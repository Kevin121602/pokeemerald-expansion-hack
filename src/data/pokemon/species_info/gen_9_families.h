...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_NACLSTACK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_GARGANACL}),
    },
    ...
    [SPECIES_FLITTLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_ESPATHRA}),
    },
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)   \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_GRASS, ABILITY_INNER_FOCUS,                    BODY_COLOR_GREEN, 1, 7, 1, FALSE),
    [SPECIES_OGERPON_WELLSPRING]       = OGERPON_SPECIES_INFO(Wellspring,  Wellspring,      TYPE_WATER, ABILITY_WATER_VEIL,                     BODY_COLOR_BLUE,  1, 7, 0, FALSE),
