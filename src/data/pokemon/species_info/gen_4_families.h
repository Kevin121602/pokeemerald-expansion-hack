...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARLY] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_RECKLESS, ABILITY_NONE },
    #else
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_INTIMIDATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_UNNERVE, ABILITY_NONE, ABILITY_QUEENLY_MAJESTY },
        .availableHidden = TRUE,
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_TOXICROAK}),
    },
