...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_NONE, ABILITY_ADAPTABILITY },
        .availableHidden = TRUE,
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_AROMA_VEIL, ABILITY_NONE },
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_UNBURDEN, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_HARVEST, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities = { ABILITY_TELEPATHY, ABILITY_INFILTRATOR, ABILITY_AERILATE },
        .availableHidden = TRUE,
        .bodyColor = BODY_COLOR_PURPLE,
