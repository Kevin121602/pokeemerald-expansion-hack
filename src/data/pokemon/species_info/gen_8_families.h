...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_TOXEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_TOXTRICITY_AMPED, CONDITIONS({IF_AMPED_NATURE})},
                                {EVO_LEVEL, 28, SPECIES_TOXTRICITY_LOW_KEY, CONDITIONS({IF_LOW_KEY_NATURE})}),
    },
