...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_NONE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OWN_TEMPO, ABILITY_SIMPLE },
    #else
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_MYSTIC_CHARM, ABILITY_MYSTIC_CHARM, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_SILCOON, 22, SPECIES_GOREBYSS},
                                {EVO_LEVEL_CASCOON, 22, SPECIES_HUNTAIL}),
    },
