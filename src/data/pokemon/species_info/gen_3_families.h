...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_QUICK_FEET, ABILITY_NONE, ABILITY_GLUTTONY },
    #else
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_RAIN_DISH, ABILITY_NONE, ABILITY_HYDRATION },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_PELIPPER}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_SHARPNESS, ABILITY_NONE, ABILITY_JUSTIFIED },
    #else
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 55, SPECIES_SLAKING}),
    },
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_RATTLED, ABILITY_PUNK_ROCK },
        .availableHidden = TRUE,
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_EXPLOUD}),
    },
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_PROBOPASS}),
    },
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_MAGNET_PULL, ABILITY_STURDY },
        .availableHidden = TRUE,
        .bodyColor = BODY_COLOR_GRAY,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_NORMALIZE, ABILITY_NONE, ABILITY_WONDER_SKIN },
    #else
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_MEDICHAM}),
    },
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_MINUS, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_NONE, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TINTED_LENS, ABILITY_NONE, ABILITY_PRANKSTER },
    #else
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_ROSELIA}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_TECHNICIAN, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_SWALOT}),
    },
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_MULTISCALE, ABILITY_NONE, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_WAILORD}),
    },
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_SIMPLE },
    #else
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_GRUMPIG}),
    },
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_VIBRAVA}),
    },
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_FLYGON}),
    },
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_FATAL_PRECISION, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_HYDRATION, ABILITY_ADAPTABILITY },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_WHISCASH}),
    },
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_CRAWDAUNT}),
    },
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_CLAYDOL}),
    },
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_CRADILY}),
    },
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_ARMALDO}),
    },
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_DUSKNOIR}),
    },
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_INTIMIDATE, ABILITY_NONE, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .availableHidden = TRUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_HARVEST },
    #else
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_NONE, ABILITY_JUSTIFIED },
    #else
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_SEALEO}),
    },
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_GOREBYSS, CONDITIONS({IF_PID_UPPER_MODULO_10_GT, 4})},
                                {EVO_LEVEL, 22, SPECIES_HUNTAIL, CONDITIONS({IF_PID_UPPER_MODULO_10_LT, 4})}),
    },
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_DAZZLING, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_NONE, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SHELGON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 60, SPECIES_SALAMENCE}),
    },
    ...
    [SPECIES_METANG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 60, SPECIES_METAGROSS}),
    },
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_NONE, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_RED,
