...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_RUN_AWAY, ABILITY_NONE },
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_TINTED_LENS, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_NONE, ABILITY_EARLY_BIRD },
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_INSOMNIA, ABILITY_SNIPER, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_GREEN,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_SERENE_GRACE, ABILITY_AERILATE },
        .availableHidden = TRUE,
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_PLUS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_JUMPLUFF}),
    },
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_INFILTRATOR, ABILITY_COTTON_DOWN },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INFILTRATOR },
    #endif
        .availableHidden = TRUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_NONE, ABILITY_SOLAR_POWER },
    #else
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                               \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                                      \
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_WONDER_GUARD },                          \
        .bodyColor = BODY_COLOR_BLACK,                                                                  \
        .noFlip = _noFlip,                                                                              \
        .speciesName = _("Unown"),                                                                      \
        .cryId = CRY_UNOWN,                                                                             \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_WOBBUFFET}),
    },
#endif //P_GEN_3_CROSS_EVOS
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RATTLED, ABILITY_SERENE_GRACE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Sneasel"),
        .cryId = CRY_SNEASEL,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_UNBURDEN, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA},
                                {EVO_LEVEL, 60, SPECIES_URSALUNA_BLOODMOON}),
    },
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_STURDY },
        .availableHidden = TRUE,
        .bodyColor = BODY_COLOR_GRAY,
