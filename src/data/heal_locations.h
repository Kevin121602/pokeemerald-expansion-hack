...
{
    [HEAL_LOCATION_CENTER_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(CENTER_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(CENTER_TOWN_PLAYERS_HOUSE_2F), 5, 5},
    [HEAL_LOCATION_CENTER_TOWN - 1] = {MAP_GROUP(CENTER_TOWN), MAP_NUM(CENTER_TOWN), 6, 8},
    ...
    [HEAL_LOCATION_SPIRAL_CITY - 1] = {MAP_GROUP(SPIRAL_CITY), MAP_NUM(SPIRAL_CITY), 8, 40},
    ...
    [HEAL_LOCATION_CENTER_TOWN_PLAYERS_HOUSE - 1] = {MAP_GROUP(CENTER_TOWN), MAP_NUM(CENTER_TOWN), 6, 8},
