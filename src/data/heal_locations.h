...
{
    [HEAL_LOCATION_CENTER_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(CENTER_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(CENTER_TOWN_PLAYERS_HOUSE_2F), 3, 7},
    ...
    [HEAL_LOCATION_CENTER_TOWN_PLAYERS_HOUSE - 1] = {MAP_GROUP(CENTER_TOWN), MAP_NUM(CENTER_TOWN), 5, 8},
