...
// Misc. Held Items
    ...
    [ITEM_EXP_SHARE] =
    {
        ...
        .holdEffect = HOLD_EFFECT_EXP_SHARE,
            ...
            .description = COMPOUND_STRING(
                ...
                "from battles."),
        #endif
        .pocket = I_EXP_SHARE_ITEM >= GEN_6 ? POCKET_KEY_ITEMS : POCKET_HELD_ITEMS,
        .sortType = ITEM_TYPE_HELD_ITEM,
        .type = ITEM_USE_FIELD,
    ...
    [ITEM_KINGS_ROCK] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 500 : ((I_PRICE >= GEN_7) ? 5000 : 100),
