...
const struct Tileset gTileset_NewBuilding =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_NewBuilding,
    .palettes = gTilesetPalettes_NewBuilding,
    .metatiles = gMetatiles_NewBuilding,
    .metatileAttributes = gMetatileAttributes_NewBuilding,
    .callback = NULL,
};
...
const struct Tileset gTileset_CenterLab =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CenterLab,
    .palettes = gTilesetPalettes_CenterLab,
    .metatiles = gMetatiles_CenterLab,
