...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_RICHSEDIMENT]                         = COMPOUND_STRING("The battlefield's rich sediment heightens the effects of Rock, Ground, and Steel type attacks!"),
    [STRINGID_SOOTHINGSTEAM]                        = COMPOUND_STRING("A soothing steam wafted through the battlefield!"),
    [STRINGID_SOOTHINGSTEAMHEALS]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is healed by the soothing steam!"),
    [STRINGID_SWEETDREAMSDMG]                       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s dreams are stolen!"),
