...
const u8 gText_WhichForm[] = _("Change to which form?");
...
const u8 gText_LvlCapVar[] = _("{STR_VAR_1}");
...
const u8 gText_DeepSeaTooth[] = _("Deep Sea Tooth");
const u8 gText_DeepSeaScale[] = _("Deep Sea Scale");
...
ALIGNED(4) const u8 gText_Receive[] = _("Recieve");
...
const u8 gText_AttackLC[] = _("Attack");
const u8 gText_DefenseLC[] = _("Defense");
const u8 gText_SpAtkLC[] = _("Sp. Attack");
const u8 gText_SpDefLC[] = _("Sp. Defense");
const u8 gText_SpeedLC[] = _("Speed");
const u8 gText_ExitLC[] = _("Exit");
const u8 gText_StatNameColon[] =_("{STR_VAR_1}:");
const u8 gText_Natures_Serious[] =     _("Serious (1 Scale)");
const u8 gText_Natures_Lax[] =       _("Lax     (1 Scale)");
const u8 gText_Natures_Gentle[] =    _("Gentle  (1 Scale)");
const u8 gText_Natures_Brave[] =     _("Brave   (2 Scales)");
const u8 gText_Natures_Bold[] =      _("Bold    (2 Scales)");
const u8 gText_Natures_Relaxed[] =   _("Relaxed (2 Scales)");
const u8 gText_Natures_Impish[] =    _("Impish  (2 Scales)");
const u8 gText_Natures_Quiet[] =     _("Quiet   (2 Scales)");
const u8 gText_Natures_Calm[] =      _("Calm    (2 Scales)");
const u8 gText_Natures_Sassy[] =     _("Sassy   (2 Scales)");
const u8 gText_Natures_Careful[] =   _("Careful (2 Scales)");
const u8 gText_Natures_Lonely[] =    _("Lonely  (3 Scales)");
const u8 gText_Natures_Adamant[] =   _("Adamant (3 Scales)");
const u8 gText_Natures_Naughty[] =   _("Naughty (3 Scales)");
const u8 gText_Natures_Timid[] =     _("Timid   (3 Scales)");
const u8 gText_Natures_Hasty[] =     _("Hasty   (3 Scales)");
const u8 gText_Natures_Jolly[] =     _("Jolly   (3 Scales)");
const u8 gText_Natures_Naive[] =     _("Naive   (3 Scales)");
const u8 gText_Natures_Modest[] =    _("Modest  (3 Scales)");
const u8 gText_Natures_Mild[] =      _("Mild    (3 Scales)");
const u8 gText_Natures_Rash[] =      _("Rash    (3 Scales)");
const u8 gText_Natures_Serious1[] =     _("Serious");
const u8 gText_Natures_Lax1[] =       _("Lax");
const u8 gText_Natures_Gentle1[] =    _("Gentle");
const u8 gText_Natures_Brave1[] =     _("Brave");
const u8 gText_Natures_Bold1[] =      _("Bold");
const u8 gText_Natures_Relaxed1[] =   _("Relaxed");
const u8 gText_Natures_Impish1[] =    _("Impish");
const u8 gText_Natures_Quiet1[] =     _("Quiet");
const u8 gText_Natures_Calm1[] =      _("Calm");
const u8 gText_Natures_Sassy1[] =     _("Sassy");
const u8 gText_Natures_Careful1[] =   _("Careful");
const u8 gText_Natures_Lonely1[] =    _("Lonely");
const u8 gText_Natures_Adamant1[] =   _("Adamant");
const u8 gText_Natures_Naughty1[] =   _("Naughty");
const u8 gText_Natures_Timid1[] =     _("Timid");
const u8 gText_Natures_Hasty1[] =     _("Hasty");
const u8 gText_Natures_Jolly1[] =     _("Jolly");
const u8 gText_Natures_Naive1[] =     _("Naive");
const u8 gText_Natures_Modest1[] =    _("Modest");
...
const u8 gText_AddExp[] =             _("Add Exp. Points. {L_BUTTON}{R_BUTTON} -+ 100");
const u8 gText_FirstPuzzle[] =        _("First Puzzle");
const u8 gText_SecondPuzzle[] =       _("Second Puzzle");
const u8 gText_ThirdPuzzle[] =        _("Third Puzzle");
const u8 gText_FourthPuzzle[] =       _("Fourth Puzzle");
const u8 gText_FifthPuzzle[] =        _("Fifth Puzzle");
...
const u8 gText_SwitchItems[] =        _("Switch Items");
const u8 gText_BoostItems[] =         _("Boost Items");
const u8 gText_Herbs[] =              _("Herbs");
const u8 gText_EjectPack[] =          _("Eject Pack");
const u8 gText_EjectButton[] =        _("Eject Button");
const u8 gText_RedCard[] =            _("Red Card");
const u8 gText_LiechiBerry[] =        _("Liechi Berry");
const u8 gText_GanlonBerry[] =        _("Ganlon Berry");
const u8 gText_SalacBerry[] =         _("Salac Berry");
const u8 gText_PetayaBerry[] =        _("Petaya Berry");
const u8 gText_ApicotBerry[] =        _("Apicot Berry");
const u8 gText_LansatBerry[] =        _("Lansat Berry");
const u8 gText_StarfBerry[] =         _("Starf Berry");
const u8 gText_MicleBerry[] =         _("Micle Berry");
const u8 gText_CustapBerry[] =        _("Custap Berry");
const u8 gText_JabocaBerry[] =        _("Jaboca Berry");
const u8 gText_RowapBerry[] =         _("Rowap Berry");
const u8 gText_KeeBerry[] =           _("Kee Berry");
const u8 gText_MarangaBerry[] =       _("Maranga Berry");
const u8 gText_AbsorbBulb[] =         _("Absorb Bulb");
const u8 gText_CellBattery[] =        _("Cell Battery");
const u8 gText_LuminousMoss[] =       _("Luminous Moss");
const u8 gText_Snowball[] =           _("Snowball");
...
const u8 gText_ElectricSeed[] =       _("Electric Seed");
const u8 gText_PsychicSeed[] =        _("Psychic Seed");
const u8 gText_MistySeed[] =          _("Misty Seed");
const u8 gText_GrassySeed[] =         _("Grassy Seed");
...
const u8 gText_SplicerSmall[] =       _("Small");
const u8 gText_SplicerAverage[] =     _("Average");
const u8 gText_SplicerLarge[] =       _("Large");
const u8 gText_SplicerSuper[] =       _("Super");
const u8 gText_NectarBaile[] =        _("Baile");
...
const u8 BattleFrontier_Lounge5_Text_NatureGirlAttackHighAttackLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlAttackHighDefenseLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlAttackHighSupportLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlDefenseHighAttackLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlDefenseHighDefenseLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlDefenseHighSupportLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlSupportHighAttackLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlSupportHighDefenseLow[] = _(" ");
const u8 BattleFrontier_Lounge5_Text_NatureGirlSupportHighSupportLow[] = _(" ");
