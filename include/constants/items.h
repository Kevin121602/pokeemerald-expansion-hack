...
#define ITEM_RESEARCH_NOTES ITEM_DEVON_PARTS // Pre-Gen VI name
...
//new items, somehow values of new items got divided by 2 in 1.4.0 merge
#define ITEM_RAINBOW_NECTAR 855
