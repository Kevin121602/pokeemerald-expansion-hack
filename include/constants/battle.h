...
#define STATUS_FIELD_SOOTHING_STEAM                 (1 << 22)
...
enum BattleWeather
{
    ...
    BATTLE_WEATHER_VICIOUS_SANDSTORM,
    BATTLE_WEATHER_SNOW,
    BATTLE_WEATHER_HAIL,
...
#define B_WEATHER_ERRATIC           (1 << BATTLE_WEATHER_ERRATIC)  // unused
#define B_WEATHER_RAIN              (B_WEATHER_RAIN_NORMAL | B_WEATHER_RAIN_PRIMAL | B_WEATHER_ERRATIC)
#define B_WEATHER_SUN_NORMAL        (1 << BATTLE_WEATHER_SUN)
#define B_WEATHER_SUN_PRIMAL        (1 << BATTLE_WEATHER_SUN_PRIMAL)
#define B_WEATHER_SUN               (B_WEATHER_SUN_NORMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_ERRATIC)
#define B_WEATHER_SANDSTORM_NORMAL  (1 << BATTLE_WEATHER_SANDSTORM)
#define B_WEATHER_VICIOUS_SANDSTORM (1 << BATTLE_WEATHER_VICIOUS_SANDSTORM)
#define B_WEATHER_SANDSTORM         (B_WEATHER_SANDSTORM_NORMAL | B_WEATHER_VICIOUS_SANDSTORM)
#define B_WEATHER_SNOW_NORMAL       (1 << BATTLE_WEATHER_SNOW)
#define B_WEATHER_HAIL_NORMAL       (1 << BATTLE_WEATHER_HAIL)
#define B_WEATHER_HEAVY_HAIL        (1 << BATTLE_WEATHER_HEAVY_HAIL)
#define B_WEATHER_SNOW              (B_WEATHER_SNOW_NORMAL | B_WEATHER_HEAVY_HAIL)
#define B_WEATHER_HAIL              (B_WEATHER_HAIL_NORMAL | B_WEATHER_HEAVY_HAIL)
#define B_WEATHER_FOG               (1 << BATTLE_WEATHER_FOG)
#define B_WEATHER_STRONG_WINDS      (1 << BATTLE_WEATHER_STRONG_WINDS)

#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_FOG)
#define B_WEATHER_DAMAGING_ANY  (BATTLE_WEATHER_HAIL | B_WEATHER_SANDSTORM)
#define B_WEATHER_ICY_ANY       B_WEATHER_SNOW
#define B_WEATHER_LOW_LIGHT     (B_WEATHER_FOG | B_WEATHER_ICY_ANY | B_WEATHER_RAIN | B_WEATHER_SANDSTORM)
#define B_WEATHER_PRIMAL_ANY    (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_VICIOUS_SANDSTORM | B_WEATHER_HEAVY_HAIL | B_WEATHER_STRONG_WINDS)
