...
#define B_WEATHER_ERRATIC             (1 << 1)
#define B_WEATHER_RAIN_PERMANENT      (1 << 2)
#define B_WEATHER_RAIN_PRIMAL         (1 << 3)
#define B_WEATHER_RAIN                (B_WEATHER_RAIN_TEMPORARY | B_WEATHER_RAIN_PERMANENT | B_WEATHER_RAIN_PRIMAL)
#define B_WEATHER_SANDSTORM_TEMPORARY (1 << 4)
#define B_WEATHER_SANDSTORM_PERMANENT (1 << 5)
#define B_WEATHER_SANDSTORM           (B_WEATHER_SANDSTORM_TEMPORARY | B_WEATHER_SANDSTORM_PERMANENT | B_WEATHER_VISCIOUS_SANDSTORM)
...
#define B_WEATHER_HAIL                (B_WEATHER_HAIL_TEMPORARY | B_WEATHER_HAIL_PERMANENT | B_WEATHER_HEAVY_HAIL)
...
#define B_WEATHER_VISCIOUS_SANDSTORM  (1 << 14)
#define B_WEATHER_HEAVY_HAIL          (1 << 15)
...
#define ENUM_WEATHER_ERRATIC              9
#define ENUM_WEATHER_VISCIOUS_SANDSTORM   10
#define ENUM_WEATHER_HEAVY_HAIL           11
