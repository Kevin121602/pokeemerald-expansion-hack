...
#define I_ROTOM_CATALOG_THUNDER_SHOCK   FALSE  // In Gen9+, reverting Rotom to its base form will teach it Thunder Shock even if it knows another move.
...
#define I_FISHING_MINIGAME         GEN_9      // Each generation uses a variation of reeling in Pokémon once they have been hooked. NOTE: Only the Gen 1/2 and Gen 3 minigames are implemented right now!
